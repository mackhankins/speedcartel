    ...
    <div 
        ...
        x-init="
            ...
            @if($model && $model->{$modelPhotoField})
                photoPreview = '{{ asset('storage/' . $model->{$modelPhotoField}) }}';
            @endif
        ...
        <div x-show="!isCropping" class="relative">
            ...
            <div class="flex items-center space-x-6">
                ...
                <div class="flex-shrink-0">
                    <div class="relative h-{{ $previewSize }} w-{{ $previewSize }} {{ $cropperType === 'circle' ? 'rounded-full' : 'rounded-lg' }} overflow-hidden bg-gray-100 dark:bg-gray-700">
                        ...
                        <template x-if="!photoPreview">
                            <div class="h-{{ $previewSize }} w-{{ $previewSize }} {{ $cropperType === 'circle' ? 'rounded-full' : 'rounded-lg' }} flex items-center justify-center bg-gray-100 dark:bg-gray-700">
                                <svg class="h-{{ (int)($previewSize/2) }} w-{{ (int)($previewSize/2) }} text-gray-400" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs {{ $disabled ? 'text-amber-600 dark:text-amber-400' : 'text-gray-500 dark:text-gray-400' }}">
