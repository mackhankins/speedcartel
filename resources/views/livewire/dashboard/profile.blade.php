<div>
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white font-orbitron mb-8">Profile Settings</h1>
        
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <!-- Profile Information -->
            <div class="bg-white dark:bg-light-gray shadow rounded-2xl px-6 py-8">
                <h2 class="text-xl font-bold text-gray-900 dark:text-white font-orbitron">Profile Information</h2>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Update your account information.</p>
                ...
                <form wire:submit="updateProfile" class="mt-6 space-y-4">
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <div class="block w-full px-4 py-3 bg-gray-50 dark:bg-dark-gray border border-gray-300 dark:border-gray-600 rounded-xl shadow-sm text-gray-500 dark:text-gray-400">
                                {{ Auth::user()->email }}
                            </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input type="tel" wire:model.live="phone" id="phone" 
                                x-data="{ phone: $wire.phone }"
                                x-init="$watch('phone', value => $wire.phone = value)"
                                x-mask="(999) 999-9999"
                                x-on:input="phone = $event.target.value"
                                class="block w-full px-4 py-3 bg-white dark:bg-light-gray border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-red-400/30 dark:focus:ring-red-500/50 focus:border-red-400 dark:focus:border-red-500 focus:outline-none rounded-xl shadow-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500"
                                placeholder="(555) 555-5555">
                            @error('phone') <span class="mt-2 text-sm text-red-600">{{ $message }}</span> @enderror
                            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Optional. Used for order notifications and shipping updates.</p>
                        </div>
                    </div>
            ...
            <!-- Update Password -->
            <div class="bg-white dark:bg-light-gray shadow rounded-2xl px-6 py-8">
                <h2 class="text-xl font-bold text-gray-900 dark:text-white font-orbitron">Update Password</h2>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Ensure your account is using a secure password.</p>
            ...
            <div class="bg-white dark:bg-light-gray shadow rounded-2xl px-6 py-8">
                <h2 class="text-xl font-bold text-gray-900 dark:text-white font-orbitron">Two Factor Authentication</h2>
                ...
                @if($showingConfirmation)
                    <div class="mt-6">
                        <p class="text-sm text-gray-600 dark:text-gray-400">
                            To finish enabling two factor authentication, scan the QR code and enter the code from your authenticator app.
                        </p>
                        <div class="mt-4">
            ...
            <div class="bg-white dark:bg-light-gray shadow rounded-2xl px-6 py-8 lg:col-span-2">
                <div class="flex justify-between items-center">
                    <div>
                        <h2 class="text-xl font-bold text-gray-900 dark:text-white font-orbitron">Addresses</h2>
                ...
                <form wire:submit="saveAddress" class="mt-6 space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <div class="mt-1">
                                <select wire:model.live="address_type" id="address_type" class="block w-full px-4 py-3 bg-white dark:bg-light-gray border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-red-400/30 dark:focus:ring-red-500/50 focus:border-red-400 dark:focus:border-red-500 focus:outline-none rounded-xl shadow-sm text-gray-900 dark:text-white">
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="text" wire:model.live="full_name" id="full_name" class="block w-full px-4 py-3 bg-white dark:bg-light-gray border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-red-400/30 dark:focus:ring-red-500/50 focus:border-red-400 dark:focus:border-red-500 focus:outline-none rounded-xl shadow-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500">
                                @error('full_name') <span class="mt-2 text-sm text-red-600">{{ $message }}</span> @enderror
                            </div>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="mt-1">
                                <input type="text" wire:model.live="address_line1" id="address_line1" class="block w-full px-4 py-3 bg-white dark:bg-light-gray border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-red-400/30 dark:focus:ring-red-500/50 focus:border-red-400 dark:focus:border-red-500 focus:outline-none rounded-xl shadow-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500">
                                @error('address_line1') <span class="mt-2 text-sm text-red-600">{{ $message }}</span> @enderror
                            </div>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="mt-1">
                                <input type="text" wire:model.live="address_line2" id="address_line2" class="block w-full px-4 py-3 bg-white dark:bg-light-gray border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-red-400/30 dark:focus:ring-red-500/50 focus:border-red-400 dark:focus:border-red-500 focus:outline-none rounded-xl shadow-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="text" wire:model.live="city" id="city" class="block w-full px-4 py-3 bg-white dark:bg-light-gray border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-red-400/30 dark:focus:ring-red-500/50 focus:border-red-400 dark:focus:border-red-500 focus:outline-none rounded-xl shadow-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500">
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="text" wire:model.live="state" id="state" class="block w-full px-4 py-3 bg-white dark:bg-light-gray border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-red-400/30 dark:focus:ring-red-500/50 focus:border-red-400 dark:focus:border-red-500 focus:outline-none rounded-xl shadow-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500">
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="text" wire:model.live="postal_code" id="postal_code" class="block w-full px-4 py-3 bg-white dark:bg-light-gray border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-red-400/30 dark:focus:ring-red-500/50 focus:border-red-400 dark:focus:border-red-500 focus:outline-none rounded-xl shadow-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500">
                                @error('postal_code') <span class="mt-2 text-sm text-red-600">{{ $message }}</span> @enderror
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="text" wire:model.live="country" id="country" class="block w-full px-4 py-3 bg-white dark:bg-light-gray border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-red-400/30 dark:focus:ring-red-500/50 focus:border-red-400 dark:focus:border-red-500 focus:outline-none rounded-xl shadow-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500">
                        ...
                        <div class="md:col-span-2">
                            <label class="inline-flex items-center">
                                <input type="checkbox" wire:model.live="is_default" id="is_default" class="h-4 w-4 text-red-600 focus:ring-red-500 border-gray-300 rounded">
